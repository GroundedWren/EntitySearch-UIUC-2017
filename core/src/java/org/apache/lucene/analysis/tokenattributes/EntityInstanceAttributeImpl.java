...
/** Default implementation of {@link EntityInstanceAttribute}. */
public class EntityInstanceAttributeImpl extends AttributeImpl implements EntityInstanceAttribute, TermToBytesRefAttribute, Cloneable {
  ...
  public EntityInstanceAttributeImpl() {}
  ...
  @Override
  public final EntityInstanceAttribute setLength(int length) {
  ...
  @Override
  public final EntityInstanceAttribute setEmpty() {
    termLength = 0;
    return this;
  }
  ...
  @Override
  public final EntityInstanceAttribute append(CharSequence csq) {
  ...
  @Override
  public final EntityInstanceAttribute append(CharSequence csq, int start, int end) {
    if (csq == null) // needed for Appendable compliance
      csq = "null";
  ...
  @Override
  public final EntityInstanceAttribute append(char c) {
  ...
  @Override
  public final EntityInstanceAttribute append(String s) {
  ...
  @Override
  public final EntityInstanceAttribute append(StringBuilder s) {
    if (s == null) // needed for Appendable compliance
      return appendNull();
    final int len = s.length();
    s.getChars(0, len, resizeBuffer(termLength + len), termLength);
  ...
  @Override
  public final EntityInstanceAttribute append(EntityInstanceAttribute ta) {
  ...
  private EntityInstanceAttribute appendNull() {
  ...
  public AttributeImpl clone() {
    EntityInstanceAttributeImpl t = (EntityInstanceAttributeImpl)super.clone();
    // Do a deep clone
  ...
  public boolean equals(Object other) {
    ...
    if (other instanceof EntityInstanceAttributeImpl) {
      final EntityInstanceAttributeImpl o = ((EntityInstanceAttributeImpl) other);
