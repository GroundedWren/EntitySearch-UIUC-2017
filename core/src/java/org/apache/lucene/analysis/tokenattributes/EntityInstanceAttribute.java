...
/**
 * The entity instance of an Entity occurrence.
 */
public interface EntityInstanceAttribute extends Attribute, CharSequence, Appendable {
   ...
   */
  public EntityInstanceAttribute setLength(int length);
  
  /** Sets the length of the termBuffer to zero.
   * Use this method before appending contents
   * using the {@link Appendable} interface.
   */
  public EntityInstanceAttribute setEmpty();
  
  // the following methods are redefined to get rid of IOException declaration:
  @Override
  public EntityInstanceAttribute append(CharSequence csq);
  @Override
  public EntityInstanceAttribute append(CharSequence csq, int start, int end);
  @Override
  public EntityInstanceAttribute append(char c);
   ...
   */
  public EntityInstanceAttribute append(String s);
   ...
   * characters {@code "null"} are appended. 
   */
  public EntityInstanceAttribute append(StringBuilder sb);
   ...
   * characters {@code "null"} are appended. 
   */
  public EntityInstanceAttribute append(EntityInstanceAttribute termAtt);
}
